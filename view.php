        ...
        <div class="row">
            <div class="col-md-7" name="fileBody" id="fileBody">
                ...
                if ($result[0]["Type"] == File::$types["PICTURE"])
                {
                    ...
                    if (isset($_GET["r"]))
                        echo "<img src='file.php?name=".$filename."&r' style='max-width: 100%;' alt='" . htmlspecialchars($result[0]["Description"], ENT_QUOTES) . " image upload creation user " . htmlspecialchars(getUsername($result[0]["User_ID"]), ENT_QUOTES) . " quality'></img>"; 
                    else
                        echo "<img src='file.php?name=".$filename."' style='max-width: 100%;' alt='" . htmlspecialchars($result[0]["Description"], ENT_QUOTES) . " image upload creation user " . htmlspecialchars(getUsername($result[0]["User_ID"]), ENT_QUOTES) . " quality'></img>"; 
                    echo "</a>";
                }
